    ...
    >
      <div className="container mx-auto px-4 pt-28 md:pt-32 pb-16 md:pb-24 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="gsap-section bg-[var(--color-bg-light-secondary)] border border-[var(--color-border-light)] p-4 rounded-lg mb-6">
            <p className="text-[var(--color-text-on-light-secondary)]">
          ...
          <h3 className="gsap-section text-xl font-semibold mt-6 mb-3 text-[var(--color-accent)]">
          ...
          <ul className="gsap-section list-disc pl-6 mb-4 text-[var(--color-text-on-light-secondary)]">
